...
import { ACL_MODULE_CONFIG, AclModuleConfig, AclDb } from './config';
...
export class AclService {
    ...
    /**
     * Fetch the UserAcl for a given userId
     * @param userId 
     */
    ...
    * @param groupId 
    */
    async revokeGroup(userId: string, groupId: string) {
